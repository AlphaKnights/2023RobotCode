...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final MAXSwerveModule m_frontLeft = new MAXSwerveModule(
      ...
      DriveConstants.kFrontLeftChassisAngularOffset, DriveConstants.kModuleNames[0]);

  private final MAXSwerveModule m_frontRight = new MAXSwerveModule(
      DriveConstants.kFrontRightDrivingCanId,
      DriveConstants.kFrontRightTurningCanId,
      DriveConstants.kFrontRightChassisAngularOffset, DriveConstants.kModuleNames[0]);

  private final MAXSwerveModule m_rearLeft = new MAXSwerveModule(
      DriveConstants.kRearLeftDrivingCanId,
      DriveConstants.kRearLeftTurningCanId,
      DriveConstants.kBackLeftChassisAngularOffset, DriveConstants.kModuleNames[0]);

  private final MAXSwerveModule m_rearRight = new MAXSwerveModule(
      DriveConstants.kRearRightDrivingCanId,
      DriveConstants.kRearRightTurningCanId,
      DriveConstants.kBackRightChassisAngularOffset, DriveConstants.kModuleNames[0]);
